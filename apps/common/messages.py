...
ORDER_TYPE_PROCESSING = "Ordo Order - Processing"
...
OFFICE_VENDOR_EXIST = "This Vendor is already linked with another User"
OFFICE_VENDOR_SAME_COMPANY = "This account is already linked with same company from another User"

# Accounts
NO_ADMIN_MEMBER = "A company must have at least 1 company member."
NOT_ALLOWED_FOR_USER = "It's not allowed for user."
