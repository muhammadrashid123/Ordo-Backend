            ...
            fields=[
                ...
                (
                    ...
                    creditcards.models.CardNumberField(
                        blank=True, max_length=25, null=True, verbose_name="Card Number"
                    ),
                ),
                (
                    "cc_expiry",
                    creditcards.models.CardExpiryField(blank=True, null=True, verbose_name="Expiration Date"),
                ),
                (
                    "cc_code",
                    creditcards.models.SecurityCodeField(
                        blank=True, max_length=4, null=True, verbose_name="Security Code"
                    ),
                ),
                (
                    "company",
            ...
            fields=[
                ...
                (
                    ...
                    apps.common.models.FlexibleForeignKey(
                        ...
                        related_name="connected_vendors",
                        to="accounts.office",
                    ),
                ),
                (
                    ...
                    apps.common.models.FlexibleForeignKey(
                        on_delete=django.db.models.deletion.CASCADE,
                        related_name="connected_offices",
                        to="accounts.vendor",
                    ),
                ),
            ],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "address_type",
                    models.CharField(
                        choices=[("address", "Address"), ("billing", "Billing Address")],
                        default="address",
                        max_length=10,
                    ),
                ),
                ...
                (
                    "office",
                    apps.common.models.FlexibleForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, related_name="addresses", to="accounts.office"
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "dental_budget_type",
                    models.CharField(
                        choices=[("production", "Adjusted Production"), ("collection", "Collection")],
                        default="production",
                        max_length=10,
                    ),
                ),
                ...
                (
                    "office",
                    apps.common.models.FlexibleForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, related_name="budgets", to="accounts.office"
                    ),
                ),
            ],
            options={
